...
### 2. "Port 6379 já em uso"
O Redis do Docker Compose não precisa publicar a porta `6379` no host, pois a API acessa o cache pela rede interna do Docker em `redis://redis:6379`.

Se precisar abrir o console do Redis, use:

```bash
docker compose exec redis redis-cli
```

### 3. O Frontend só exibe um máximo de 20 obras
...
### 4. "Erro de Conexão com o BD" (Prisma)
